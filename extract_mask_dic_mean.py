...
# DATA
parser.add_argument('--root_path', type=str, default='/home/FYP/sims0038',
                    help='path to root path of images')
parser.add_argument('--train_list', type=str, default='CASIA_train_sin_cc.txt',help='path to training list')
...
# Network
parser.add_argument('--weight_model', type=str, default='ash/Sep06-19-57-04/CosFace_13_checkpoint.pth')
parser.add_argument('--save_path', type=str, default='masks/mean/',
