...
def eval(model_path=None):
    predicts = []
    # if sphere20.is_cuda:
    #model = sphere.sphere(type=20, is_gray=False)
    ...
    model.eval()
    model = model.cuda()
    root = '/home/FYP/sims0038/LFW_cropped_112x96'
...
if __name__ == '__main__':
    #KFold()
    eval('/home/FYP/sims0038/cosface_train/chkpt_7/CosFace_1_checkpoint.pth')
    pass
